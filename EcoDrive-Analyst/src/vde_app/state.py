...
VDE_SETUP_CTX_DEFAULTS = {
    ...
    "vde_setup_input_mode": "Spreadsheet",
    "spreadsheet_roadload_total_basis": "coastdown",
    "spreadsheet_roadload_total_source": "measured/manual",
    "spreadsheet_abc_net_apply": False,
    "spreadsheet_abc_net_basis": "derived/manual",
    "spreadsheet_abc_net_source": "trans loss removed",
    "spreadsheet_abc_net_A": None,
    "spreadsheet_abc_net_B": None,
    "spreadsheet_abc_net_C": None,
    "spreadsheet_transmission_source_label": "test/manual",
    "spreadsheet_roadload_errors": [],
    "spreadsheet_transmission_errors": [],
    "spreadsheet_component_errors": [],
    "spreadsheet_component_tires_apply": None,
    "spreadsheet_component_brakes_apply": None,
    "spreadsheet_component_parasitics_apply": None,
...
VDE_SETUP_VOLATILE_KEYS = (
    ...
    "trans_B_coef_Npkph",
    "trans_C_coef_Npkph2",
    "spreadsheet_roadload_total_basis",
    "spreadsheet_roadload_total_source",
    "spreadsheet_abc_net_apply",
    "spreadsheet_abc_net_basis",
    "spreadsheet_abc_net_source",
    "spreadsheet_abc_net_A",
    "spreadsheet_abc_net_B",
    "spreadsheet_abc_net_C",
    "spreadsheet_transmission_source_label",
    "spreadsheet_roadload_errors",
    "spreadsheet_transmission_errors",
    "spreadsheet_component_errors",
    "spreadsheet_component_tires_apply",
    "spreadsheet_component_brakes_apply",
    "spreadsheet_component_parasitics_apply",
    "baseline_id",
    "baseline_dict",
